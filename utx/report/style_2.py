...
<head>
    ...
    <style type="text/css">
        ...
        .appium_case-activity-list .appium_case-element {
            border-bottom: 1px solid #e7eaec
        }

        .appium_case-element:first-child {
            margin-top: 0
        }
        ...
        .appium_case-element, .appium_case-element .media {
            margin-top: 15px
        }

        .appium_case-element, .media-body {
            overflow: hidden
        }
        ...
        .appium_case-element > .pull-left {
            margin-right: 10px
        }

        .appium_case-element img.img-circle, .dropdown-messages-box img.img-circle {
            width: 38px;
            height: 38px
        }

        .appium_case-element .well {
            border: 1px solid #e7eaec;
            box-shadow: none;
            margin-top: 10px;
            margin-bottom: 5px;
        ...
        .appium_case-element .actions {
            margin-top: 10px
        }

        .appium_case-element .photos {
            margin: 10px 0
        }

        .right.appium_case-element > .pull-right {
            margin-left: 10px
        }
        ...
        .appium_case li.left .appium_case-body {
            margin-left: 60px
        }

        .appium_case li.right .appium_case-body {
            margin-right: 60px
        }

        .appium_case li .appium_case-body p {
            margin: 0;
            color: #777
        }

        .appium_case .glyphicon, .panel .slidedown .glyphicon {
            margin-right: 5px
        }

        .appium_case-panel .panel-body {
            height: 350px;
            overflow-y: scroll
        }
        ...
        .appium_case-statistic, .appium_case-users {
            margin-left: -30px
        }
        ...
        .appium_case-discussion .appium_case-message:nth-child(2n+1) .message-avatar {
            float: left;
            margin-right: 10px
        }

        .appium_case-discussion .appium_case-message:nth-child(2n) .message-avatar {
            float: right;
            margin-left: 10px
        }
        ...
        .appium_case-discussion .appium_case-message:nth-child(2n+1) .message-date {
            float: right
        }

        .appium_case-discussion .appium_case-message:nth-child(2n) .message-date {
            float: left
        }

        .appium_case-discussion .appium_case-message:nth-child(2n+1) .message {
            text-align: left;
            margin-left: 55px
        }

        .appium_case-discussion .appium_case-message:nth-child(2n) .message {
            text-align: right;
            margin-right: 55px
        }
        ...
        .appium_case-message-form .form-group {
            margin-bottom: 0
        }
        ...
        #small-appium_case .badge {
            position: absolute;
            top: -3px;
            right: -4px
        }

        .open-small-appium_case {
            height: 38px;
            width: 38px;
            display: block;
            background: #1ab394;
        ...
        .open-small-appium_case:hover {
            color: #fff;
            background: #1ab394
        }

        .small-appium_case-box {
            display: none;
            position: fixed;
            bottom: 50px;
            right: 80px;
        ...
        .small-appium_case-box.ng-small-appium_case {
            display: block
        }

        .body-small .small-appium_case-box {
            bottom: 70px;
            right: 20px
        }

        .small-appium_case-box.active {
            display: block
        }

        .small-appium_case-box .heading {
            background: #2f4050;
            padding: 8px 15px;
            font-weight: 700;
            color: #fff
        ...
        .small-appium_case-box .appium_case-date {
            opacity: .6;
            font-size: 10px;
            font-weight: 400
        }

        .small-appium_case-box .content {
            padding: 15px
        }

        .small-appium_case-box .content .author-name {
            font-weight: 700;
            margin-bottom: 3px;
            font-size: 11px
        }

        .small-appium_case-box .content > div {
            padding-bottom: 20px
        }

        .small-appium_case-box .content .appium_case-message {
            padding: 5px 10px;
            border-radius: 6px;
            font-size: 11px;
            line-height: 14px;
        ...
        .small-appium_case-box .content .appium_case-message.active {
            background: #1ab394;
            color: #fff
        }

        .small-appium_case-box .content .left {
            text-align: left;
            clear: both
        }

        .small-appium_case-box .content .left .appium_case-message {
            float: left
        }

        .small-appium_case-box .content .right {
            text-align: right;
            clear: both
        }

        .small-appium_case-box .content .right .appium_case-message {
            float: right
        }

        .small-appium_case-box .form-appium_case {
            padding: 10px
        }
        ...
        body.rtls .appium_case-statistic, body.rtls .appium_case-users {
            margin-right: -30px;
            margin-left: auto
        }
